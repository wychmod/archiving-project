 ...
 */
@observer
class ReportContentTwo extends React.Component {
    render() {
        // 复用组件
        ...
        //         JSON.stringify(BloodFatStore.BloodLipidContent) === '{}' ||
        ...
        const bloodFat = BloodFatStore.BloodLipidContent;
        ...
        // const hypertension = ascvd.chronic_illness.split(',').filter(ill => ill === "高血压")
        // const diabetes = ascvd.chronic_illness.split(',').filter(ill => ill === "糖尿病")
                    ...
                    <Row className="report-content">
                        ...
                        <Col span={16} offset={4}>
                            ...
                            <Descriptions className="report-content-table" column={4}>
                                ...
                                <Descriptions.Item
                                    label="ASCVD病史">{information.ascvd_history ? "是" : ""}</Descriptions.Item>
                                <Descriptions.Item
                            ...
                            <Descriptions className="report-content-table-main" column={10}>
                                <Descriptions.Item span={10}>血脂与脂蛋白检测（样本类型:{bloodFat.Lipid_lipoprotein_type}{'\u00A0\u00A0\u00A0'}
                                    条码号:{bloodFat.Lipid_lipoprotein_barcode}{'\u00A0\u00A0\u00A0'}样本号：{bloodFat.Lipid_lipoprotein_number}{'\u00A0\u00A0\u00A0'}
                                    样本状态：{bloodFat.Lipid_lipoprotein_status}）</Descriptions.Item>
                                {descriptionsMain(
                                    '1', '甘油三酯', 'TG',
                                    bloodFat.tg, 'mmol/L', '0.40-1.70', ''
                                )}
                                {descriptionsMain(
                                    '2', '载脂蛋白A1', 'ApoA1',
                                    bloodFat.Apo_A1, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '3', '载脂蛋白B', 'ApoB',
                                    bloodFat.Apo_B, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '4', '脂蛋白(a)', 'Lp(a)',
                                    bloodFat.LP_a, 'mmol/L', '', ''
                                )}
                                <Descriptions.Item span={10}>血脂亚组分检测（样本类型:{bloodFat.blood_type}{'\u00A0\u00A0\u00A0'}
                                    条码号:{bloodFat.blood_barcode}{'\u00A0\u00A0\u00A0'}样本号：{bloodFat.blood_number}{'\u00A0\u00A0\u00A0'}
                                    样本状态：{bloodFat.blood_status}）</Descriptions.Item>
                                {descriptionsMain(
                                    '1', '总胆固醇', 'TC',
                                    bloodFat.tc, 'mmol/L', '3.10-5.72', ''
                                )}
                                {descriptionsMain(
                                    '2', '高密度脂蛋白胆固醇', 'HDL-C',
                                    bloodFat.HDL_C, 'mmol/L', '1.0-2.1', ''
                                )}
                                {descriptionsMain(
                                    '3', '低密度脂蛋白胆固醇', 'LDL-C',
                                    bloodFat.LDL_C, 'mmol/L', '0-3.37', ''
                                )}
                                {descriptionsMain(
                                    '4', '低密度脂蛋白亚型<sub>4+3+2+1</sub>胆固醇', 'LDL<sub>4+3+2+1</sub>',
                                    bloodFat.LDL_4321, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '5', '非高密度脂蛋白胆固醇', 'non-HDL',
                                    bloodFat.non_HDL, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '6', '中间密度脂蛋白胆固醇', 'IDL',
                                    bloodFat.IDL, 'mmol/L', '', ''
                                ...
                                {descriptionsMain(
                                    '7', '极低密度脂蛋白胆固醇', 'VLDL',
                                    bloodFat.VLDL, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '8', '高密度脂蛋白2', 'HDL2',
                                    bloodFat.HDL2, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '9', '高密度脂蛋白3', 'HDL3',
                                    bloodFat.HDL3, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '10', '残粒样脂蛋白胆固醇', 'RLP-C',
                                    bloodFat.RLP_C, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '11', '极低密度脂蛋白3', 'VLDL3',
                                    bloodFat.VLDL3, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                                    '12', '小而密低密度脂蛋白胆固醇', 'sdLDL-C',
                                    bloodFat.sdLDL_C, 'mmol/L', '', ''
                                )}
                                {descriptionsMain(
                            ...
                            <Descriptions className="report-content-table-title" column={1}>
                                ...
                                <Descriptions.Item>{bloodFat.conclusion}</Descriptions.Item>
                            </Descriptions>
...
export default ReportContentTwo;