 ...
 */
@observer
export default class ReportContentBlood extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Step0: "process",
            ...
            <div className="medical-report">
                <Row>
                    <Col span={20}>
                        ...
                        {this.state.current === 1 && <ReportContentTwo onPreStep={() => this.onChangeSteps(0)} onNextStep={this.props.onNextStep}/>}
                    </Col>
                </Row>
            </div>
        )
