package com.wychmod.domain.support.ids;

import com.wychmod.Constants;
import com.wychmod.domain.support.ids.policy.RandomNumeric;
import com.wychmod.domain.support.ids.policy.ShortCode;
import com.wychmod.domain.support.ids.policy.SnowFlake;
