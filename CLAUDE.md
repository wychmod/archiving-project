...
6. 同步展示站:在 `showcase/src/content/projects/{zh,en}/` 各新增一条内容条目,front matter 与素材规范见 `AGENTS.md` §2.3;改完后跑 `npm run build` 与 `npm run check:links`(展示站设计与构建约定见 `AGENTS.md` §2.4 与 `showcase/docs/DESIGN-V2.md`)
